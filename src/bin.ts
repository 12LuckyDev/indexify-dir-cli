...
program
  ...
  .option('-n --no-add-extension', 'If set exports will be written without extension')
  .addOption(
  ...
  .addOption(
    new Option('-a --all-extensions', 'Include all files, no matter what extension they have')
      .default(false)
